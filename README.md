...
L'application est encore en phase de développement et de rodage. Notre ambition est claire : une fois que le code sera bien éprouvé et testé, nous prévoyons de compiler l'application en fichier APK pour la rendre accessible plus facilement sur mobile.
